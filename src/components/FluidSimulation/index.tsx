...
canvasElem.style.right = "0";
canvasElem.style.bottom = "0";
...
const baseVertexShader = compileShader(gl.VERTEX_SHADER, baseVertexShaderText);
...
const advectionShader = compileShader(gl.FRAGMENT_SHADER, advectionShaderText);
...
const vorticityShader = compileShader(gl.FRAGMENT_SHADER, vorticityShaderText);
